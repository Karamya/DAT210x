...
C = 1
kernel = 'linear'
iterations = 5000   # TODO: Change from 5000 to 200000 once you get to Question#2
...
#adding in a Decision Tree Classifier, setting its max_depth to 9, 
...
benchmark(dtc, 'DecisionTreeClassifier')
drawPlots(dtc, 'DecisionTreeClassifier')
