...
def load(path_test, path_train):
  ...
  X_train = X_train[:int(math.ceil(len(X_train))*0.04)]
  y_train = y_train[:int(math.ceil(len(y_train))*0.04)]
...
# .. your code here ..
plt.figure()
plt.imshow(X_test.ix[1000, :].reshape(8,8), cmap = plt.cm.gist_gray_r, interpolation = 'None')
plt.show()

# Accuracy score : 0.961024498886
#
...
### gamma = 0.0001  gives 0.982739420935 and gamma = 0.002 gives 0.985523385301
### c = 2 gives 0.9844 and c = 0.1 gives 0.964365
