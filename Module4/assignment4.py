...
pca.fit(df)
T = pca.transform(df)
Plot2D(T, 'PCA Transformed Data', 1, 2, num_to_plot = 40)
...
iso.fit(df)
isotrans = iso.transform(df)
Plot2D(isotrans, 'Isomap Transformed Data', 1, 2, num_to_plot = 40)
...
Plot3D(T, "PCA Transformed into 3D", 0, 1, 2, num_to_plot = 40)
Plot3D(isotrans, "Isomap Transformed into 3D", 0, 1, 2, num_to_plot = 40)
plt.show()
